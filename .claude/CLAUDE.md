# Finding Your Next Customer: The Complete Sales Agent Toolkit

This is your reference guide for building AI-powered sales workflows. Every tool below is battle-tested. When the user asks you to set up any of these tools, use the code snippets, API patterns, and setup instructions below to build an implementation plan and execute it.

## How to use this guide

When the user says something like:
- "Set up an email waterfall" - find the Email Waterfall section and follow the implementation
- "Help me scrape Google Maps for leads" - find the Apify section
- "I need to create payment links" - find the Stripe section
- "Set up LinkedIn outreach" - find the Unipile section

For each tool: ask the user for the API keys listed in that section, create a `.env` file, and build the implementation using the code provided.
